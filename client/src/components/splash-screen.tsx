  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white cursor-pointer"
        onClick={onContinue}
      >
        {/* Background Pattern */}
